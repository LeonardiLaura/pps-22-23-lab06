...
object FunctionsImpl extends Functions:
  ...
  override def concat(a: Seq[String]): String = a.foldRight("")(_.concat(_))
  override def max(a: List[Int]): Int = a.foldRight(Integer.MIN_VALUE)( _.max(_) )
  override def combiner[A](a: Seq[A], combiner: Combiner[A]): A = a.foldRight(combiner.unit)(combiner.combine)
